...
namespace Conversion
{
    ...
    // interface -> abstract class (optional)  -> class -_> 
    // MovableObject -> HUman -> asian -> Chinese, Vioetnamese,  Laos -> ng hue, ng mien nam -> ng tphcm, ng ben tre -> 
    // MovableObject -> Animal -> dog
    //                         -> mammal -> dog
    //                         -> non mammal -> komonodo dragon
